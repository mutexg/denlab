...
Note: the user-agent style is a built-in CSS style sheet that lives in the LibWeb source code [here](https://github.com/DenLabOS/denlab/blob/master/Userland/Libraries/LibWeb/CSS/Default.css).
