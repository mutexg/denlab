/*
 * Copyright (c) 2024, Idan Horowitz <idan.horowitz@denlabos.org>
 *
...
{
    VERIFY(m_interrupt_count < 256); // TODO: DenLab currently only supports up to 256 unique interrupts, but the PLIC supports up to 1024
    initialize();
}
