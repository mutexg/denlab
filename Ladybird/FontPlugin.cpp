/*
 * Copyright (c) 2022-2023, Andreas Kling <kling@denlabos.org>
 * Copyright (c) 2023, Linus Groh <linusg@denlabos.org>
 *
...
void FontPlugin::update_generic_fonts()
{
    ...
    auto update_mapping = [&](Web::Platform::GenericFont generic_font, ReadonlySpan<FlyString> fallbacks) {
        if (m_is_layout_test_mode) {
            m_generic_font_names[static_cast<size_t>(generic_font)] = "DenLabSans"_fly_string;
            return;
        }
