...
static ErrorOr<ByteString> find_certificates(StringView denlab_resource_root)
{
    auto cert_path = ByteString::formatted("{}/ladybird/cacert.pem", denlab_resource_root);
...
ErrorOr<int> denlab_main(Main::Arguments arguments)
{
    ...
    if (certificates.is_empty())
        certificates.append(TRY(find_certificates(denlab_resource_root)));
