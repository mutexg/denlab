...
ByteString s_denlab_resource_root;
...
void platform_init()
{
    ...
    Core::ResourceImplementation::install(make<Core::ResourceImplementationFile>(MUST(String::from_byte_string(s_denlab_resource_root))));
}
