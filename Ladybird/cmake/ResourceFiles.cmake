file(STRINGS "${DENLAB_SOURCE_DIR}/Meta/emoji-file-list.txt" EMOJI)
list(TRANSFORM EMOJI PREPEND "${DENLAB_SOURCE_DIR}/Base/res/emoji/")
...
set(FONTS
    ...
    DenLabSans-Regular.ttf
)
list(TRANSFORM FONTS PREPEND "${DENLAB_SOURCE_DIR}/Base/res/fonts/")
...
list(TRANSFORM 16x16_ICONS PREPEND "${DENLAB_SOURCE_DIR}/Base/res/icons/16x16/")
list(TRANSFORM 32x32_ICONS PREPEND "${DENLAB_SOURCE_DIR}/Base/res/icons/32x32/")
list(TRANSFORM BROWSER_ICONS PREPEND "${DENLAB_SOURCE_DIR}/Base/res/icons/browser/")
...
list(TRANSFORM WEB_RESOURCES PREPEND "${DENLAB_SOURCE_DIR}/Base/res/ladybird/")
list(TRANSFORM WEB_TEMPLATES PREPEND "${DENLAB_SOURCE_DIR}/Base/res/ladybird/templates/")

set(THEMES
    Default.ini
    Dark.ini
)
list(TRANSFORM THEMES PREPEND "${DENLAB_SOURCE_DIR}/Base/res/themes/")

set(CONFIG_RESOURCES
    BrowserAutoplayAllowlist.txt
    BrowserContentFilters.txt
)
list(TRANSFORM CONFIG_RESOURCES PREPEND "${DENLAB_SOURCE_DIR}/Base/home/anon/.config/")
