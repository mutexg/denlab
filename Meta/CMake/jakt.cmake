...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
    set(os "win32")
elseif (${CMAKE_SYSTEM_NAME} STREQUAL "DenLabOS")
    set(os "denlab")
else()
    string(TOLOWER ${CMAKE_SYSTEM_NAME} os)
endif()

set(JAKT_COMPILER "${DenLabOS_SOURCE_DIR}/Toolchain/Local/jakt/bin/jakt")
...
if(${PROJECT_NAME} STREQUAL "Lagom")
    ...
    set(JAKT_LIBRARY_BASE "${DenLabOS_SOURCE_DIR}/Toolchain/Local/jakt/lib")
else()
    set(JAKT_LIBRARY_BASE "${DenLabOS_SOURCE_DIR}/Toolchain/Local/jakt/usr/local/lib")
endif()
set(JAKT_LIBRARY_DIR "${JAKT_LIBRARY_BASE}/${JAKT_TARGET_TRIPLE}")
set(JAKT_INCLUDE_DIR "${DenLabOS_SOURCE_DIR}/Toolchain/Local/jakt/usr/local/include/runtime")
...
if (ENABLE_JAKT)
    if (NOT EXISTS ${JAKT_COMPILER})
        ...
        set(all_includes
            ${INCLUDE_DIRECTORIES}
            ${DenLabOS_SOURCE_DIR}
            ${DenLabOS_SOURCE_DIR}/Userland/Libraries
            ${DenLabOS_SOURCE_DIR}/Userland/Libraries/LibCrypt
            ${DenLabOS_SOURCE_DIR}/Userland/Libraries/LibSystem
            ${DenLabOS_SOURCE_DIR}/Userland/Services
            ${DenLabOS_SOURCE_DIR}/Userland
        )
...
function(denlab_jakt_app target_name source)
    cmake_parse_arguments(PARSE_ARGV 2 DENLAB_JAKT_EXECUTABLE "" "" "INCLUDES;CONFIGS;LINK_LIBRARIES")
    add_jakt_executable(${target_name} ${source}
        INCLUDES
            ...
            ${DENLAB_JAKT_EXECUTABLE_INCLUDES}
        CONFIGS ${DENLAB_JAKT_EXECUTABLE_CONFIGS}
        LINK_LIBRARIES ${DENLAB_JAKT_EXECUTABLE_LINK_LIBRARIES}
    )
    set_target_properties(${target_name} PROPERTIES EXCLUDE_FROM_ALL TRUE)
    install(TARGETS ${target_name} RUNTIME DESTINATION bin OPTIONAL)
    denlab_generated_sources(${target_name})
    denlab_set_implicit_links(${target_name})
endfunction(denlab_jakt_app)

function(denlab_jakt_executable target_name)
    cmake_parse_arguments(PARSE_ARGV 1 DENLAB_JAKT_EXECUTABLE "" "" "MAIN_SOURCE;CPP_SOURCES;CONFIGS;LINK_LIBRARIES")
    add_jakt_executable(${target_name} ${DENLAB_JAKT_EXECUTABLE_MAIN_SOURCE}
        INCLUDES
            ${INCLUDE_DIRECTORIES}
            ${PROJECT_SOURCE_DIR}
            ${PROJECT_SOURCE_DIR}/Userland/Libraries
        ...
        CONFIGS ${DENLAB_JAKT_EXECUTABLE_CONFIGS}
        LINK_LIBRARIES ${DENLAB_JAKT_EXECUTABLE_LINK_LIBRARIES}
        EXTRA_CPP_SOURCES ${DENLAB_JAKT_EXECUTABLE_CPP_SOURCES}
    )
endfunction()
