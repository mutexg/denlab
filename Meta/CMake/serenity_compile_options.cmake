...
add_compile_options(-ffile-prefix-map=${DenLabOS_SOURCE_DIR}=.)
...
elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang$")
    ...
    link_directories(${TOOLCHAIN_ROOT}/lib/clang/${LLVM_MAJOR_VERSION}/lib/${DENLAB_ARCH}-pc-denlab/)
endif()

if ("${DENLAB_ARCH}" STREQUAL "riscv64")
