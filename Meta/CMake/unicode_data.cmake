...
set(UCD_PATH "${DENLAB_CACHE_DIR}/UCD" CACHE PATH "Download location for UCD files")
...
set(EMOJI_RES_PATH "${DenLabOS_SOURCE_DIR}/Base/res/emoji")
set(EMOJI_DENLAB_PATH "${DenLabOS_SOURCE_DIR}/Base/home/anon/Documents/emoji-denlab.txt")
set(EMOJI_FILE_LIST_PATH "${DenLabOS_SOURCE_DIR}/Meta/emoji-file-list.txt")
...
if (ENABLE_UNICODE_DATABASE_DOWNLOAD)
    ...
    invoke_generator(
        ...
        arguments "${EMOJI_INSTALL_ARG}" -e "${EMOJI_TEST_PATH}" -s "${EMOJI_DENLAB_PATH}" -f "${EMOJI_FILE_LIST_PATH}" -r "${EMOJI_RES_PATH}"
        ...
        dependencies "${EMOJI_RES_PATH}" "${EMOJI_DENLAB_PATH}" "${EMOJI_FILE_LIST_PATH}"
    )
    invoke_generator(
        "IDNAData"
