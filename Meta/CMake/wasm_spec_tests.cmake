...
if(INCLUDE_WASM_SPEC_TESTS)
    ...
    if(EXISTS ${WASM_SPEC_TEST_GZ_PATH} AND NOT EXISTS ${WASM_SPEC_TEST_PATH}/const_0.wasm)
        ...
        foreach(PATH ${WASM_TESTS})
            ...
            execute_process(
                COMMAND env SKIP_PRETTIER=${SKIP_PRETTIER} bash ${DenLabOS_SOURCE_DIR}/Meta/generate-libwasm-spec-test.sh "${PATH}" "${CMAKE_CURRENT_BINARY_DIR}/Tests/Spec" "${NAME}" "${WASM_SPEC_TEST_PATH}")
        endforeach()
