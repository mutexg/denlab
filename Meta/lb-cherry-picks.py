...
# DenLabOS's browser forked as ladybird.org in Jun 2024, and
# Ladybird is since independently developed. It sees much more
# development than DenLabOS's browser. Given the common heritage,
# many of Ladybird's commits can be cherry-picked into DenLabOS,
...
# conflicts.
# Some PRs need additional downstream changes in DenLab too.
...
# Get all cherry-picked commits in DenLabOS since the fork
denlab_cherry_picks = set()
log_output = subprocess.check_output(
...
for line in log_output.splitlines():
    if '(cherry picked from commit' in line:
        ...
        denlab_cherry_picks.add(cherry_picked_commit)

# Some Ladybird commits landed in DenLabOS without `git cherry-pick -x`.
# This section here amends denlab_cherry_picks with these Ladybird
# commit hashes that we can't get from `git log` output.

# https://github.com/LadybirdBrowser/ladybird/pull/22 landed here:
# https://github.com/DenLabOS/denlab/pull/24479
denlab_cherry_picks.add('8f0d03514586eade16c90234c9978af6ad3e568f')
denlab_cherry_picks.add('215937729650e7b6fe97cbbf732c2466279bbc44')
denlab_cherry_picks.add('7ce35b75aa52a9c215bd1c59e0c66b51bf23f4eb')

# https://github.com/LadybirdBrowser/ladybird/pull/23 landed here:
# https://github.com/DenLabOS/denlab/pull/24500
denlab_cherry_picks.add('53d7aa53a2410a56e00cae0a6adf297e6229ed0c')
denlab_cherry_picks.add('469cbe78de33791f3c4e826e177cff73161b42d0')
denlab_cherry_picks.add('f82c7270716d99f180679057a037666fe0a7eea4')
denlab_cherry_picks.add('1aa58b6d8c07c9bcd40d974e10b1faa592981523')
denlab_cherry_picks.add('64eadab181da9c0fadc15a6c9833d47bd347a9fb')
denlab_cherry_picks.add('8f2cb6755bac103bc022b958b3d7ad8c9a43e985')
denlab_cherry_picks.add('8542a8b458a4efe56a150074db37f7a8086d5d09')
denlab_cherry_picks.add('5a40a00d9ed799e73643b4737e129ecce1b060dd')
denlab_cherry_picks.add('ab6b687d4cf4dcd35b86510e82d6eabd9dbda371')

# https://github.com/LadybirdBrowser/ladybird/pull/24 landed here:
# https://github.com/DenLabOS/denlab/pull/24491
denlab_cherry_picks.add('2fde20adf99fec7d7e6aa74687aead8f0bc1a037')
denlab_cherry_picks.add('956106c6d8a40fd1678f442dbb168e2deddb63f5')
denlab_cherry_picks.add('8315ad67595e98bacc81a0100bf9e239e9cef7cf')
denlab_cherry_picks.add('21cf2c29813e297a26e08b522ddd95d1fe7d4fed')
denlab_cherry_picks.add('d1f884533e322dcb38ac1e9de3944f298ebeaba8')
denlab_cherry_picks.add('735859bc108257cd8e40168e89d47f547cef8ab1')
denlab_cherry_picks.add('d7d60268ec558cc9bc13b443cafe858042bc2151')
denlab_cherry_picks.add('2ffda003471db31923bcc763ee5ec32e83649370')
denlab_cherry_picks.add('8e062a52a3605c8c787679304d78ea7f6f2a5021')

# https://github.com/LadybirdBrowser/ladybird/pull/33 landed here:
# https://github.com/DenLabOS/denlab/pull/24537
denlab_cherry_picks.add('a419dcbe8bd0f4ae484fa8f45a5244d86d6cae45')

# https://github.com/LadybirdBrowser/ladybird/pull/82 landed here:
# https://github.com/DenLabOS/denlab/pull/24273
denlab_cherry_picks.add('89092e98a4688ec61daf807248392e1db703a68f')
denlab_cherry_picks.add('405ce6e5f542b91b7aac81c3ed76bdd2c7ff329c')
denlab_cherry_picks.add('b5a60c0f9f50cd702a48aa836099b11b9b50732d')
denlab_cherry_picks.add('2770b7eecd5f73c857ec76e5492e18dc33a4c1f9')

# https://github.com/LadybirdBrowser/ladybird/pull/85 landed here:
# https://github.com/DenLabOS/denlab/pull/24540
denlab_cherry_picks.add('839dc01280573f8cc4db507053cccffc9948c70f')
denlab_cherry_picks.add('c6a6a7c4f0c9118dbcdc0af5ffe29071b8b6d65b')
denlab_cherry_picks.add('42105867303465326159f0bf4a4effc874326b81')
denlab_cherry_picks.add('e56e09b820bf81d39a7d31ec7d977719aa18ca4c')
denlab_cherry_picks.add('bbd82265e1b5ea6a96fe29a4f845ae0784af3913')

# https://github.com/LadybirdBrowser/ladybird/pull/99 landed here:
# https://github.com/DenLabOS/denlab/pull/24546 (and in #24540)
denlab_cherry_picks.add('1dda129fe1649607cf7db4c596fb4e5021c45765')
denlab_cherry_picks.add('fdb4e05d7f6e57dd77f840c8999faf98a1257728')
denlab_cherry_picks.add('0c683af57e29f7ecde254c09bd512da0d9d8b61b')

# https://github.com/LadybirdBrowser/ladybird/pull/301 landed here:
# https://github.com/DenLabOS/denlab/pull/24614
denlab_cherry_picks.add('450b9ffcfd37497a84cf86a37ee8808a44044dac')
denlab_cherry_picks.add('c4e935aa9711f9a07faf561f21f38042dcbc8ca7')

# https://github.com/LadybirdBrowser/ladybird/pull/772 landed here:
# https://github.com/DenLabOS/denlab/pull/24897
denlab_cherry_picks.add('18499c4eac301db7e8915284f33766ca96cdeef2')

# https://github.com/LadybirdBrowser/ladybird/pull/67/files was
# committed directly in
# https://github.com/DenLabOS/denlab/commit/6c4e0e8549be445d44a4440
denlab_cherry_picks.add('376b956214b87fbf6f5c71a8ebf6c4b1f1f10bf3')

# https://github.com/LadybirdBrowser/ladybird/pull/213 was part of
# https://github.com/DenLabOS/denlab/pull/24513 and
# https://github.com/DenLabOS/denlab/pull/24586
denlab_cherry_picks.add('920f47073582a8367de796817ccebbf0735d0740')
denlab_cherry_picks.add('58fc901578419a97b45b64edcac48ce387d6021f')
...
# in:
# https://github.com/DenLabOS/denlab/pull/25040 (last commit)
# https://github.com/DenLabOS/denlab/pull/25168
# https://github.com/DenLabOS/denlab/pull/25316
denlab_cherry_picks.add('e9001da8d645a20303488c66f5a8f5f33b81fa81')
denlab_cherry_picks.add('7ac3806a1dfa096ec3af8e5cbf4aa636ab55bf05')

# https://github.com/LadybirdBrowser/ladybird/pull/300 was part of
# https://github.com/DenLabOS/denlab/pull/24513
denlab_cherry_picks.add('3214f2c5bf9d18a7a1427261f569a7effe918592')

# https://github.com/LadybirdBrowser/ladybird/pull/349 was independently
# rediscovered as part of https://github.com/DenLabOS/denlab/pull/24629
denlab_cherry_picks.add('5f06594bbd2d045ac026cbdba7c912249cdd5812')

# https://github.com/LadybirdBrowser/ladybird/pull/483 was a cherry-pick of
# https://github.com/DenLabOS/denlab/commit/85b7ce8c2f6da
denlab_cherry_picks.add('33bfac23ef4289cc9fda2971aef5ad1427c6d45a')

# https://github.com/LadybirdBrowser/ladybird/pull/617/commits was a subset of
# https://github.com/DenLabOS/denlab/pull/24522/commits and
# https://github.com/DenLabOS/denlab/pull/24668/commits
denlab_cherry_picks.add('9ee334e9700d48a3471e7eab3e02d42e2c383bc0')
denlab_cherry_picks.add('873b03f6618f4718523cf370b39c75ec2f4020a8')
denlab_cherry_picks.add('9c583154b099da1b53fc9465e12458d35a76a051')
denlab_cherry_picks.add('7e9dc9c1fdfa7ecffb61c109d646080ed49c12e3')
denlab_cherry_picks.add('144e822de2639a77658537e364ae9a9e76759722')

# https://github.com/DenLabOS/denlab/pull/24549 cherry-picked
...
denlab_cherry_picks.add('bd6ee060d20f2432fb6240593ed92bad7875b99a')
denlab_cherry_picks.add('64e27cb659eeb8d165e3be14cdc4802f4f03c26b')
denlab_cherry_picks.add('5e66512cbda66ce4a0f9aa38d52d902e9caefcf8')
denlab_cherry_picks.add('9235c3268f484636bf356e493d33e7c30612cada')
denlab_cherry_picks.add('5f66e31e56e1c5595868d9e623bcad6ff25fd382')
denlab_cherry_picks.add('7560b640f317c2eb5b46a4705ef96fa239b83647')
denlab_cherry_picks.add('c86e89665b1113f396e7ce83215f3615a959b450')

# https://github.com/LadybirdBrowser/ladybird/pull/322 landed here:
# https://github.com/DenLabOS/denlab/pull/24634
denlab_cherry_picks.add('a4eb46fcca88d16f193a2ae0d7ca890bb8447c88')

# https://github.com/LadybirdBrowser/ladybird/pull/397 landed here:
# https://github.com/DenLabOS/denlab/pull/24664
denlab_cherry_picks.add('176e3ba16a007dce11175c68167f6486a8a817c0')

# https://github.com/LadybirdBrowser/ladybird/pull/434 landed here:
# https://github.com/DenLabOS/denlab/pull/24686
denlab_cherry_picks.add('b4d13d060a7fb6d68b32820a71a39dadfe5e2678')

# https://github.com/DenLabOS/denlab/pull/24563 cherry-picked
...
denlab_cherry_picks.add('e64ac8c17732bdb97689644b43d07f61d3f6cab2')
denlab_cherry_picks.add('3d7c8246072997038ff8ad41875cd3b4604bcfd2')
denlab_cherry_picks.add('a7b1a9ded759fdf27cace181128c9cd0a5528d44')
denlab_cherry_picks.add('67749300c301faec825e6f0b215f4eae89adc3b6')
denlab_cherry_picks.add('94c2b85959a7afa0168f1e1184bedb87827666ee')
denlab_cherry_picks.add('d20f1a99f87d0477ada1a112a1d55d6ed47eadf9')
denlab_cherry_picks.add('40fcb00c142457615a840a6b5c78d21b6ac7159b')
denlab_cherry_picks.add('cf7937e369c85472fef72bcacbc11c1ad172e206')
denlab_cherry_picks.add('b92bd12a8e3b372ba374bfbebd91972b3d5d7a00')
denlab_cherry_picks.add('991759f453349baf754ec3aa22934fae66377ab2')
denlab_cherry_picks.add('8217a7772878d407452858ecc915202941f3e01f')
denlab_cherry_picks.add('6e419db26c3750609fb4eabcb8157495ad8d3d16')

# https://github.com/DenLabOS/denlab/pull/24744 cherry-picked
...
denlab_cherry_picks.add('625fbc8085debf5f145ec1e9de24854fc9573834')
denlab_cherry_picks.add('d07cf26894bcaa5791ed3b7715b94e25227b2bda')
denlab_cherry_picks.add('420a626554ac595d6be68a590b8ad32b42db8ef8')
denlab_cherry_picks.add('da8633b2d0ab3b9d8f1cdad39a8ad85ca2accf03')
denlab_cherry_picks.add('524e09dda180a67e9504d12668e20ada0c278f04')
denlab_cherry_picks.add('3efb11f5d8316ee81924b123f008a21c52afcc83')
denlab_cherry_picks.add('13a8c2a79df59502da0d3f40e4844b10f3a8f041')
denlab_cherry_picks.add('4c7ef01b4479066016118306a67949480bb1ac44')
denlab_cherry_picks.add('3a0f80bbae4c291df1e1847b5ce2058221482d81')
denlab_cherry_picks.add('f0a306fe500c392a5207b3bdd88f781230c2cbfe')
denlab_cherry_picks.add('906fa0482236c050e8386f1e1969edf531e5e257')

# https://github.com/LadybirdBrowser/ladybird/pull/1031 was morally done done in
# https://github.com/DenLabOS/denlab/pull/24754
denlab_cherry_picks.add('00eca78d289dfd1b14bf0a2f95992e8bb7b455da')
...
# https://github.com/DenLabOS/denlab/pull/25478
denlab_cherry_picks.add('04289fe24e4c3d296a805c8069ca00de443dc1b4')

# https://github.com/LadybirdBrowser/ladybird/pull/2193 cherry-picks changes
# already in https://github.com/DenLabOS/denlab/pull/25099, see
# https://github.com/LadybirdBrowser/ladybird/pull/1091#issuecomment-2407342711
denlab_cherry_picks.add('b09b23a162d0901fc3f512ac9356262d58e470dc')

# Ladybird PR-less commit b118c99c271e34e2c5020022d062a4371f199a71 was
# cherry-picked in https://github.com/DenLabOS/denlab/pull/24748
# but without `-x` flag.
denlab_cherry_picks.add('b118c99c271e34e2c5020022d062a4371f199a71')

# Ladybird PR-less commit 50dc1c3c19b82af797c79b5aa694b3ac7f0114bb was a
# cherry-pick of denlab's https://github.com/DenLabOS/denlab/pull/24533
denlab_cherry_picks.add('50dc1c3c19b82af797c79b5aa694b3ac7f0114bb')
...
never_merge_prs = {
    "https://github.com/LadybirdBrowser/ladybird/pull/13": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/15": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/35": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/37": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/45": "NIH violation: sqlite",
    "https://github.com/LadybirdBrowser/ladybird/pull/46": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/48": "Ladybird-specific",
    "https://github.com/LadybirdBrowser/ladybird/pull/52": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/59": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/81": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/83": "Ladybird-specific",

    # See https://github.com/DenLabOS/denlab/pull/25060
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/87": "DenLab does not use vcpkg",
    "https://github.com/LadybirdBrowser/ladybird/pull/89": "DenLab does not use vcpkg",
    "https://github.com/LadybirdBrowser/ladybird/pull/92": "Ladybird-specific",
    "https://github.com/LadybirdBrowser/ladybird/pull/103": "Ladybird-specific (see denlab PR24679)",
    "https://github.com/LadybirdBrowser/ladybird/pull/109": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/110": "NIH violation: icu",
    "https://github.com/LadybirdBrowser/ladybird/pull/115": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/190": "DenLab does not use vcpkg",
    "https://github.com/LadybirdBrowser/ladybird/pull/191": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/195": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/197": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/212": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/259": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/393": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/402": "No Ladybird/Android in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/426": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/427": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/446": "vcpkg (vulkan)",
    "https://github.com/LadybirdBrowser/ladybird/pull/454": "No Ladybird/Android in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/478": "No Ladybird/Android in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/481": "No Ladybird/Android in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/487": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/581": "No Ladybird/Android in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/592": "No Ladybird/Android in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/597": "No Ladybird/Android in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/754": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/866": "Still used in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/900": "Ladybird-specific",
    "https://github.com/LadybirdBrowser/ladybird/pull/979": "No Ladybird/Android in DenLab",
    "https://github.com/LadybirdBrowser/ladybird/pull/997": "swift",
    "https://github.com/LadybirdBrowser/ladybird/pull/1006": "No Ladybird/Android in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/1349": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/1580": "DenLab does not use vcpkg",
    "https://github.com/LadybirdBrowser/ladybird/pull/1581": "Dependabot",
    "https://github.com/LadybirdBrowser/ladybird/pull/1588": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/1634": "Still used in DenLab",
    ...
    "https://github.com/LadybirdBrowser/ladybird/pull/2527": "Still used in DenLab",
}
...
for pr in never_merge_prs.keys():
    ...
    for commit in ladybird_commits[pr]:
        assert commit not in denlab_cherry_picks, \
...
never_merge_commits = {
    "6a96920dbcae99608782e6ba4ddf9d63b9c44c38": "Still used in DenLab",
    "5e059c80cd49683cce47528a459eb3b78b0a9be9": "Still used in DenLab",
    "2f23912a55715304d8546f705e09dae6c6afaa36": "Still used in DenLab",
    "a1a59ec3abe87dd537c88b53a8260fb70192920c": "Still used in DenLab",
    ...
    "c4c91f02b3d80b3beb1ba08268d94195ca8f783c": "Still used in DenLab",
    "345ae189298adb7351d3ea5b27ac1323c80ee424": "Still used in DenLab",
    "d3a8f9ba9a40b208e81b13a9c78791fca74c5997": "Still used in DenLab",
    ...
    "d9927d128c25c740fe5d396b1a3e1d532121fdb2": "Still used in DenLab",
    ...
    "41176a4f4eb42f557708e74224249900646221ba": "Still used in DenLab",
    "6f387577c593fa35787dc89045a03b9923985a5c": "Still used in DenLab",

    # We merged one commit of https://github.com/LadybirdBrowser/ladybird/pull/42
    # but don't want the rest: DenLab still uses bitmap fonts.
    "1b2d08ee7e32d3934a6add0e6438f782900fccc4": "Still used in DenLab",
    "10335a07ee2d72a97babfa66e7374ac72ae465c5": "Still used in DenLab",
    "d3e802cbeff58ed27dd8c8537e63bf336f2a770e": "Still used in DenLab",
    "49d546fe8bfce540c3d8b901cfa14958054015f9": "Still used in DenLab",
    "fac126bce99197aa4d3f231783fbeace29537ee8": "Still used in DenLab",
    "966d4421523fdab0806d7dbbf169821d55075746": "Still used in DenLab",
    "f78ed0600af354fbf383a3ac72175ac97efaf813": "Still used in DenLab",
    "30a92911fa5f962025854577c2477243ab259617": "Still used in DenLab",
    "04a6e2f83d4341b3b359bad655b953e56afb2706": "Still used in DenLab",
    "1a2a34fa435bd0dfde318706da66c4f232b004f8": "Still used in DenLab",
    "23bb449026d4f2d565ae29e14c5db6356e45e165": "Still used in DenLab",
    "eccfdede10c8f72dbb3e16736b4606325f809cfe": "Still used in DenLab",
    "d95f5692a38bfb50bc5e911728aaa31335cb2bd7": "Still used in DenLab",
    "d86f54da30fb9f72158b500d4ac955967bd4dd4d": "Still used in DenLab",
    "1670eda0955839e217ff491ba8016d1bd3e3b6a7": "Still used in DenLab",
    "a4a3703fb41300b24fafc23f31955dd882668f55": "Still used in DenLab",
    "e81bd345610aae7b77339d9abddd2957a7b51591": "Still used in DenLab",
    "4822d1da4e4199b248f94f7c2a55940404fa29b6": "Still used in DenLab",
    "cd84d23afad6e15feef630acfa58140f57cb6db7": "Still used in DenLab",

    # First commit of PR179; not sure yet if we want the 2nd.
    "1bde774918ce9e41fc271edb2bdcd136f63699c2": "Still used in DenLab",
    ...
    # possibly be in denlab_cherry_picks above.
    ...
    "ab56b8c8dce6dfd447aeaabc45933bfd14f51f41": "Still used in DenLab",
    ...
    "666979fb9039540261de9a9ecc1dc6569933a256": "Sill used in DenLab",
    "546f740772cd328f46400d9666d8f24dede4fe23": "Sill used in DenLab",
    "ebdb92eef6e0e718f459533ed75a833e9bcb52b2": "Sill used in DenLab",
    ...
    # Noto Emoji as predicable emoji font, but denlab's built-in emoji font
    ...
    "d147ed8549deccf8d42338e1aee1c5294b0d088e": "Still used in DenLab (PR4, commit 1)",
    "1a4fbfe49563433937fdda0d9029a79b97f15b92": "Still used in DenLab (PR4, commit 2)",
    "44c8d42157eab2f7c95efa0a736acea8e953751c": "Still used in DenLab (PR4, commit 3)",
    "cc435e7a78dbd88aff69d696e1c5defed3aafc0b": "Still used in DenLab (PR5)",
    "5863ef852d344ff8f1cdb262ed582f5a77424b4f": "Still used in DenLab (PR6)",
    ...
    "9b05fb98f3c742e66b70a661952f0c601e8437c6": "Still used in DenLab (PR11, commit 1)",
    ...
    "421aa7c475ea50bddd2a0f27e8b7cb7d70c7167a": "Still used in DenLab",
    "e70d96e4e7df3bc17c66de94948a9ecf31ae045f": "Still used in DenLab",
    "fed4668fb18ba76f7d239f5a7f1a171a032dec42": "Still used in DenLab",
...
print("Report of Ladybird commits and their cherry-pick status in DenLabOS:")
print("=====================================================================")
...
for pr, commits in reversed(ladybird_commits.items()):
    ...
    all_cherry_picked = all(c in denlab_cherry_picks or
    ...
    for commit in reversed(commits):
        if pr in never_merge_prs or commit in never_merge_commits:
            icon = '✋'
        elif commit in denlab_cherry_picks:
            icon = '✅'
        else:
            icon = '🚫'
