...
class DenLabPrettyPrinterLocator(gdb.printing.PrettyPrinter):
    def __init__(self):
        super(DenLabPrettyPrinterLocator, self).__init__("denlab_pretty_printers", [])
...
gdb.printing.register_pretty_printer(None, DenLabPrettyPrinterLocator(), replace=True)


class FindThreadCmd(gdb.Command):
    """
    Find DenLabOS thread for the specified TID.
    find_thread TID
    """
