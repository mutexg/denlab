...
configopts=(
    ...
    "-DCMAKE_INSTALL_PREFIX=${DENLAB_INSTALL_ROOT}/opt/SuperTuxKart"
    "-DSTK_INSTALL_DATA_DIR=${DENLAB_INSTALL_ROOT}/opt/SuperTuxKart"
    ...
    '-Bbuild'
    '-GNinja'
    "-DCMAKE_C_FLAGS=-I${DENLAB_INSTALL_ROOT}/usr/local/include/SDL2 -lcurl -lharfbuzz -lfreetype"
    "-DCMAKE_CXX_FLAGS=-I${DENLAB_INSTALL_ROOT}/usr/local/include/SDL2"
    '-DUSE_IPV6=OFF'
