...
configopts=(
    ...
    "-DSDL2_INCLUDE_DIR=${DENLAB_INSTALL_ROOT}/usr/local/include/SDL2"
    "-DSDL2_IMAGE_INCLUDE_DIR=${DENLAB_INSTALL_ROOT}/usr/local/include/SDL2"
    "-DSDL2_MIXER_INCLUDE_DIR=${DENLAB_INSTALL_ROOT}/usr/local/include/SDL2"
)
