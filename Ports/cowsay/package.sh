...
install() {
    run_nocd mkdir -p "${DENLAB_INSTALL_ROOT}/${bin_path}/"
    run cp cowsay "${DENLAB_INSTALL_ROOT}/${bin_path}/"
    run_nocd mkdir -p "${DENLAB_INSTALL_ROOT}/${cow_path_prefix}/"
    run cp -r cows/ "${DENLAB_INSTALL_ROOT}/${cow_path_prefix}/"
    run_nocd ln -sf "${bin_path}/cowsay" "${DENLAB_INSTALL_ROOT}/${bin_path}/cowthink"
}
