...
makeopts=("PLATFORM=simulator" "TARGET=denlab" "DENLAB_INSTALL_ROOT=${DENLAB_INSTALL_ROOT}")
...
install() {
    run cp output/release/simulator/denlab/epsilon.elf ${DENLAB_INSTALL_ROOT}/usr/local/bin/
}
