...
install() {
    installdir="${DENLAB_INSTALL_ROOT}/opt/ja2"
    ...
    echo "INFO: Boot up DenLabOS and run '/opt/ja2/ja2' executable in order to produce ja2.ini configuration file in the '/home/anon/.ja2'."
