...
files=(
    "https://github.com/DenLabOS/jakt/archive/${commit_hash}.tar.gz#${archive_hash}"
)
launcher_name='Jakt'
...
configure() {
    ...
    run cmake \
        ...
        -DDENLAB_SOURCE_DIR="${DENLAB_SOURCE_DIR}" \
    ...
    run cmake \
        ...
        -DCMAKE_INSTALL_PREFIX="${DENLAB_INSTALL_ROOT}/usr/local"
}
