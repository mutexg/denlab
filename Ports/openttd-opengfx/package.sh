...
install() {
    run_nocd mkdir -p ${DENLAB_INSTALL_ROOT}/usr/local/share/games/openttd/baseset/
    run_nocd cp -a opengfx-${version}/* ${DENLAB_INSTALL_ROOT}/usr/local/share/games/openttd/baseset/
}
