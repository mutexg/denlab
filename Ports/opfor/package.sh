...
post_install() {
    ...
    pushd ${DENLAB_INSTALL_ROOT}/home/anon/Games/halflife/gearbox/cl_dlls/
    "$rename_command" 's/^...//' lib*
    popd
    pushd ${DENLAB_INSTALL_ROOT}/home/anon/Games/halflife/gearbox/dlls/
    "$rename_command" 's/^...//' lib*
    popd

    # Create a launch script
    cat <<- 'EOF' > ${DENLAB_INSTALL_ROOT}/home/anon/Games/halflife/opfor.sh
#!/bin/sh
...
EOF
    chmod +x ${DENLAB_INSTALL_ROOT}/home/anon/Games/halflife/opfor.sh
