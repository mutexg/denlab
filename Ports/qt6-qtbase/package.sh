...
install() {
    ...
    echo -e $'GUI applications won\'t work without QDenLabPlatform!'
    echo -e $'\tIt\'s packaged as qt6-denlab'
    ...
    echo -e $'\thttps://github.com/DenLabOS/denlab/tree/master/Ports/qt6-qtbase'
    echo 'The development of the Qt DenLab platform plugin is happening here. Fixes for things like input handling, window management and theme integration should go here:'
    echo -e $'\thttps://github.com/DenLabPorts/QDenLabPlatform'
}
