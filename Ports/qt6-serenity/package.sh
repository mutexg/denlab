...
version=git
depends=("qt6-qtbase")
workdir=QDenLabPlatform-master
useconfigure=true
files=(
    "https://github.com/DenLabPorts/QDenLabPlatform/archive/master.zip#522cbb41e814a3d6553d3761380f9ce08e341fd5a8137ef8cfa9fe555317c6c0"
)
configopts=(
    "-GNinja"
