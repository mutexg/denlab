...
post_install() {
    ...
    echo '    Inside DenLabOS: ~/.local/share/Serious-Engine/serioussam/'
    echo "    Outside DenLabOS: ${DENLAB_SOURCE_DIR}/Base/home/anon/.local/share/Serious-Engine/serioussam/"
    echo
