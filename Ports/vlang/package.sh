...
install() {
    ...
    mkdir -p "${DENLAB_INSTALL_ROOT}/home/anon/vlang"
    cp -rf "$workdir"/* "${DENLAB_INSTALL_ROOT}/home/anon/vlang"
    ln -fs "${DENLAB_INSTALL_ROOT}/home/anon/vlang/v2" "${DENLAB_INSTALL_ROOT}/usr/local/bin/v"
}
