...
TEST_CASE(years_to_days_since_epoch_points)
{
    Array<YearAndDays, 24> test_data = { {
        ...
        { -5877640, -2147483456 },
        { 5881474, 2147444740 },
        // Very important year: https://github.com/DenLabOS/denlab/pull/16760#issuecomment-1369054745
        { -999999, -365961662 },
...
{
    // This benchmark takes consistently "0ms" on Linux, and "0ms" on DenLab.
