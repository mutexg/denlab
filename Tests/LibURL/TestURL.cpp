/*
 * Copyright (c) 2018-2022, Andreas Kling <kling@denlabos.org>
...
{
    {
        URL::URL url("http://www.denlabos.org"sv);
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(MUST(url.serialized_host()), "www.denlabos.org");
    ...
    {
        URL::URL url("https://www.denlabos.org/index.html"sv);
        EXPECT_EQ(url.is_valid(), true);
    ...
    {
        URL::URL url("https://www.denlabos.org1/index.html"sv);
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "https");
        EXPECT_EQ(MUST(url.serialized_host()), "www.denlabos.org1");
        EXPECT_EQ(url.port_or_default(), 443);
        EXPECT_EQ(url.serialize_path(), "/index.html");
        EXPECT(!url.query().has_value());
        EXPECT(!url.fragment().has_value());
    ...
    {
        URL::URL url("http://www.denlabos.org/index.html?#"sv);
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(MUST(url.serialized_host()), "www.denlabos.org");
        EXPECT_EQ(url.port_or_default(), 80);
    ...
    {
        URL::URL url("http://www.denlabos.org/index.html?foo=1&bar=2"sv);
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(MUST(url.serialized_host()), "www.denlabos.org");
        EXPECT_EQ(url.port_or_default(), 80);
    ...
    {
        URL::URL url("http://www.denlabos.org/index.html#fragment"sv);
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(MUST(url.serialized_host()), "www.denlabos.org");
        EXPECT_EQ(url.port_or_default(), 80);
    ...
    {
        URL::URL url("http://www.denlabos.org/index.html?foo=1&bar=2&baz=/?#frag/ment?test#"sv);
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(MUST(url.serialized_host()), "www.denlabos.org");
        EXPECT_EQ(url.port_or_default(), 80);
...
{
    EXPECT_EQ(URL::URL("http//denlabos.org"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("denlabos.org"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("://denlabos.org"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("://:80"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("http://denlabos.org:80:80/"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("http://denlabos.org:80:80"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("http://denlabos.org:abc"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("http://denlabos.org:abc:80"sv).is_valid(), false);
    EXPECT_EQ(URL::URL("http://denlabos.org:abc:80/"sv).is_valid(), false);
}

TEST_CASE(serialization)
{
    EXPECT_EQ(URL::URL("http://www.denlabos.org/"sv).serialize(), "http://www.denlabos.org/");
    EXPECT_EQ(URL::URL("http://www.denlabos.org:0/"sv).serialize(), "http://www.denlabos.org:0/");
    EXPECT_EQ(URL::URL("http://www.denlabos.org:80/"sv).serialize(), "http://www.denlabos.org/");
    EXPECT_EQ(URL::URL("http://www.denlabos.org:81/"sv).serialize(), "http://www.denlabos.org:81/");
    EXPECT_EQ(URL::URL("https://www.denlabos.org:443/foo/bar.html?query#fragment"sv).serialize(), "https://www.denlabos.org/foo/bar.html?query#fragment");
}
...
TEST_CASE(equality)
{
    EXPECT(URL::URL("http://denlabos.org"sv).equals("http://denlabos.org#test"sv, URL::ExcludeFragment::Yes));
    ...
    EXPECT_NE(URL::URL("http://denlabos.org/index.html"sv), URL::URL("http://denlabos.org/test.html"sv));
}
...
{
    URL::URL base_url("http://denlabos.org/index.html#fragment"sv);
    URL::URL url = base_url.complete_url("test.html"sv);
    EXPECT(url.is_valid());
    EXPECT_EQ(url.scheme(), "http");
    EXPECT_EQ(MUST(url.serialized_host()), "denlabos.org");
