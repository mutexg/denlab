...
foreach(target x86_64-pc-denlab;aarch64-pc-denlab;riscv64-pc-denlab)
    list(APPEND targets "${target}")

    set(RUNTIMES_${target}_CMAKE_BUILD_TYPE Release CACHE STRING "")
    set(RUNTIMES_${target}_CMAKE_SYSROOT ${DENLAB_${target}_SYSROOT} CACHE PATH "")
    # Prevent configure checks from trying to link to the not-yet-built startup files & libunwind.
    set(compiler_flags "-Wno-unused-command-line-argument -nostartfiles -L${DENLAB_${target}_STUBS}")
    ...
    set(RUNTIMES_${target}_CMAKE_SYSTEM_NAME DenLabOS CACHE STRING "")
    set(RUNTIMES_${target}_CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} CACHE STRING "")

    set(BUILTINS_${target}_CMAKE_BUILD_TYPE Release CACHE STRING "")
    set(BUILTINS_${target}_CMAKE_SYSROOT ${DENLAB_${target}_SYSROOT} CACHE PATH "")
    ...
    set(BUILTINS_${target}_CMAKE_SYSTEM_NAME DenLabOS CACHE STRING "")
