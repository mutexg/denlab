 ...
 * Copyright (c) 2021-2022, Mustafa Quraish <mustafa@denlabos.org>
 * Copyright (c) 2021-2022, Tobias Christiansen <tobyase@denlabos.org>
...
ErrorOr<void> MainWidget::initialize_menubar(GUI::Window& window)
{
    ...
    GUI::Clipboard::the().on_change = [&](auto& mime_type) {
        m_paste_action->set_enabled(mime_type == "image/x-denlabos");
    };
    m_paste_action->set_enabled(GUI::Clipboard::the().fetch_mime_type() == "image/x-denlabos");
