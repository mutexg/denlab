/*
 * Copyright (c) 2021-2022, the DenLabOS developers.
 *
...
void WelcomeWidget::paint_event(GUI::PaintEvent& event)
{
    ...
    painter.draw_text(rect, "DenLab"sv, m_banner_font->bold_variant(), Gfx::TextAlignment::CenterLeft, palette().base_text());
    rect.set_x(rect.x() + static_cast<int>(ceilf(m_banner_font->bold_variant().width("DenLab"sv))));
