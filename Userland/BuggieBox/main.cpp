...
// Relying on `decltype(denlab_main)` ensures that we always stay consistent with the `denlab_main` signature.
#define DECLARE_ENTRYPOINT(name) decltype(denlab_main) name##_main;
