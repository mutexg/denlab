...
bool Project::project_is_denlab() const
{
    // FIXME: Improve this heuristic
    // Running "Meta/denlab.sh copy-src" installs the denlab repository at this path in the home directory
    return m_root_path.ends_with("Source/denlab"sv);
}
