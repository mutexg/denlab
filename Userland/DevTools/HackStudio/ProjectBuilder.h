...
private:
    enum class IsDenLabRepo {
        No,
        Yes
    };

    ErrorOr<void> build_denlab_component();
    ErrorOr<void> run_denlab_component();
    ...
    IsDenLabRepo m_is_denlab { IsDenLabRepo::No };
    ByteString m_denlab_component_cmake_file;
    ByteString m_denlab_component_name;
};
}
