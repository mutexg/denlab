...
static ErrorOr<void> notify_make_not_available()
{
    ...
    notification->set_text("You probably want to install the binutils, gcc, and make ports from the root of the DenLab repository"_string);
    notification->show();
    return {};
}
