...
#    include <LibAudio/PlaybackStreamDenLab.h>
...
#if defined(AK_OS_DENLAB)
    return PlaybackStreamDenLab::create(initial_output_state, sample_rate, channels, target_latency_ms, move(data_request_callback));
#elif defined(HAVE_PULSEAUDIO)
