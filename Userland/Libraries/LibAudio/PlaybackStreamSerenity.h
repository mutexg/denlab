...
class PlaybackStreamDenLab final
...
private:
    PlaybackStreamDenLab(NonnullRefPtr<ConnectionToServer>, NonnullRefPtr<Core::Timer> polling_timer, AudioDataRequestCallback&& data_request_callback);
