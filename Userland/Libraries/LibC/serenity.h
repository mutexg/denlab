...
#include <Kernel/API/POSIX/denlab.h>
#include <stdio.h>
#include <sys/cdefs.h>
#include <time.h>
#include <unistd.h>
...
int denlab_readlink(char const* path, size_t path_length, char* buffer, size_t buffer_size);
...
int denlab_open(char const* path, size_t path_length, int options, ...);
