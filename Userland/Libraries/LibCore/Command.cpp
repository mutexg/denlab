 ...
 * Copyright (c) 2022, David Tuin <davidot@denlabos.org>
 * Copyright (c) 2023, Shannon Booth <shannon@denlabos.org>
 * Copyright (c) 2024, the DenLabOS developers.
 *
...
// Only supported in denlab mode because we use `posix_spawn_file_actions_addchdir`
#ifdef AK_OS_DENLAB
