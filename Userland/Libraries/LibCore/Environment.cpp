/*
 * Copyright (c) 2021-2022, Andreas Kling <kling@denlabos.org>
 * Copyright (c) 2021-2022, Kenneth Myhra <kennethmyhra@denlabos.org>
 * Copyright (c) 2021-2024, Sam Atkins <atkinssj@denlabos.org>
...
ErrorOr<void> put(StringView env)
{
    ...
    auto rc = ::denlab_putenv(env.characters_without_null_termination(), env.length());
#else
