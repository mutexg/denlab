...
private:
    Driver(void* dlopen_result, denlab_gpu_create_device_t device_creation_function)
        : m_dlopen_result { dlopen_result }
        , m_denlab_gpu_create_device { device_creation_function }
    {
    ...
    denlab_gpu_create_device_t m_denlab_gpu_create_device { nullptr };
};
