 ...
 * Copyright (c) 2023, Sam Atkins <atkinssj@denlabos.org>
 *
...
NonnullRefPtr<AboutDialog> AboutDialog::create(String const& name, String version, RefPtr<Gfx::Bitmap const> icon, Window* parent_window)
{
    ...
    // If we are displaying a dialog for an application, insert 'DenLabOS' below the application name
    widget->find_descendant_of_type_named<GUI::Label>("denlab_os")->set_visible(name != "DenLabOS");
