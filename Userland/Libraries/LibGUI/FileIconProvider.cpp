...
Icon FileIconProvider::icon_for_executable(ByteString const& path)
{
    ...
    // the denlab_app_icon_* sections which should contain the icons as raw PNG data. In the future it would
    ...
    static constexpr Array<IconSection, 2> icon_sections = {
        IconSection { .section_name = "denlab_icon_s"sv, .image_size = 16 },
        IconSection { .section_name = "denlab_icon_m"sv, .image_size = 32 }
    };
