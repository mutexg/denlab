...
TreeView::TreeView()
{
    ...
    m_expand_bitmap = Gfx::Bitmap::load_from_file("/res/icons/denlab/treeview-expand.png"sv).release_value_but_fixme_should_propagate_errors();
    m_collapse_bitmap = Gfx::Bitmap::load_from_file("/res/icons/denlab/treeview-collapse.png"sv).release_value_but_fixme_should_propagate_errors();
}
