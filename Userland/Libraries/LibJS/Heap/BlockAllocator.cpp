/*
 * Copyright (c) 2021-2023, Andreas Kling <kling@denlabos.org>
 *
...
// FIXME: Implement MADV_FREE and/or MADV_DONTNEED on DenLabOS.
#if defined(AK_OS_DENLAB) || defined(AK_OS_GNU_HURD) || (!defined(MADV_FREE) && !defined(MADV_DONTNEED))
...
#ifdef AK_OS_DENLAB
    auto* block = (HeapBlock*)denlab_mmap(nullptr, HeapBlock::block_size, PROT_READ | PROT_WRITE, MAP_ANONYMOUS | MAP_RANDOMIZED | MAP_PRIVATE, -1, 0, HeapBlock::block_size, name);
#else
