/*
 * Copyright (c) 2020, Stephan Unverwerth <s.unverwerth@denlabos.org>
 * Copyright (c) 2020-2022, Linus Groh <linusg@denlabos.org>
 * Copyright (c) 2021-2022, David Tuin <davidot@denlabos.org>
 * Copyright (c) 2021, Ali Mohammad Pur <mpfard@denlabos.org>
 * Copyright (c) 2021, Idan Horowitz <idan.horowitz@denlabos.org>
 * Copyright (c) 2023, Andreas Kling <kling@denlabos.org>
 *
