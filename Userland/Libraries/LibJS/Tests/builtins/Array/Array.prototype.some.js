...
test("basic functionality", () => {
    var array = ["hello", "friends", 1, 2, false, -42, { name: "denlabos" }];

    expect(array.some(value => value === "hello")).toBeTrue();
    expect(array.some(value => value === "denlab")).toBeFalse();
    ...
    expect(["", "hello", "friends", "denlab"].some(value => value.length === 0)).toBeTrue();
