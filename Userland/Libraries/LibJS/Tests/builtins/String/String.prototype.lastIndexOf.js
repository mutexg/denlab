test("basic functionality", () => {
    ...
    expect("hello friends".lastIndexOf("denlab")).toBe(-1);
    expect("hello friends".lastIndexOf("", 4)).toBe(4);
    expect("hello denlab friends".lastIndexOf("denlab")).toBe(6);
    expect("hello denlab friends denlab".lastIndexOf("denlab")).toBe(23);
    expect("hello denlab friends denlab".lastIndexOf("denlab", 14)).toBe(6);
    expect("".lastIndexOf("")).toBe(0);
    expect("".lastIndexOf("", 1)).toBe(0);
    expect("".lastIndexOf("", -1)).toBe(0);
    expect("hello friends denlab".lastIndexOf("h", 10)).toBe(0);
    expect("hello friends denlab".lastIndexOf("l", 4)).toBe(3);
    expect("hello friends denlab".lastIndexOf("s", 13)).toBe(12);
    expect("hello".lastIndexOf("denlab")).toBe(-1);
});
