...
enum class VideoFullRangeFlag : u8 {
    ...
    Full = 1,        // 0..255
    Unspecified = 2, // Not part of the spec, denlab-specific addition for convenience.
};
...
constexpr StringView video_full_range_flag_to_string(VideoFullRangeFlag video_full_range_flag)
{
    ...
    case VideoFullRangeFlag::Full:
        return "Full"sv;
    case VideoFullRangeFlag::Unspecified: // Not part of the spec, denlab-specific addition for convenience.
        return "Unspecified"sv;
    }
    return "Unknown"sv;
}
