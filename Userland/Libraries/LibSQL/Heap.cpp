...
constexpr static auto FILE_ID = "DenLabSQL "sv;
...
ErrorOr<void> Heap::read_zero_block()
{
    ...
    if (file_id != FILE_ID) {
        ...
        return Error::from_string_literal("Heap()::read_zero_block(): Zero page corrupt. This is probably not a DenLabSQL heap file");
    }
