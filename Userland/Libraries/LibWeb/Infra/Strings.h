/*
 * Copyright (c) 2022-2023, Linus Groh <linusg@denlabos.org>
 * Copyright (c) 2022, networkException <networkexception@denlabos.org>
 * Copyright (c) 2023, Kenneth Myhra <kennethmyhra@denlabos.org>
