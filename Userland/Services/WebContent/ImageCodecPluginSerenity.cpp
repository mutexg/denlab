...
#include "ImageCodecPluginDenLab.h"
#include <LibImageDecoderClient/Client.h>

namespace WebContent {

ImageCodecPluginDenLab::ImageCodecPluginDenLab() = default;
ImageCodecPluginDenLab::~ImageCodecPluginDenLab() = default;

NonnullRefPtr<Core::Promise<Web::Platform::DecodedImage>> ImageCodecPluginDenLab::decode_image(ReadonlyBytes bytes, Function<ErrorOr<void>(Web::Platform::DecodedImage&)> on_resolved, Function<void(Error&)> on_rejected)
{
    if (!m_client) {
