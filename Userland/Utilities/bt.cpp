 ...
 * Copyright (c) 2021, Kenneth Myhra <kennethmyhra@denlabos.org>
 *
        ...
        for (auto& symbol : symbols) {
            ...
            if (!symbol.source_positions.is_empty()) {
                ...
                for (size_t i = 0; i < symbol.source_positions.size(); i++) {
                    ...
                    auto full_path = LexicalPath::canonicalized_path(ByteString::formatted("/usr/src/denlab/dummy/dummy/{}", source_position.file_path));
